...
#ifndef RIDEHAL_CL2D_PIPELINE_LETTERBOX_HPP
#define RIDEHAL_CL2D_PIPELINE_LETTERBOX_HPP
...
private:
    RideHalError_e LetterboxFromNV12ToRGB( cl_mem bufferSrc, uint32_t srcOffset, cl_mem bufferDst,
...
#endif   // RIDEHAL_CL2D_PIPELINE_LETTERBOX_HPP
