...
typedef enum
{
    ...
    MOCK_CONTROL_API_OUT_PARAM0_SET_GRAPH_RETRIEVE_NULL,
} MockAPI_Action_e;
...
typedef enum
{
    ...
    MOCK_API_QNN_BACKEND_REGISTER_OP_PACKAGE,
    MOCK_API_QNN_CONTEXT_CREATE,
    MOCK_API_QNN_GRAPH_FINALIZE,
    MOCK_API_QNN_CONTEXT_CREATE_FROM_BINARY_INFO,
    MOCK_API_QNN_GRAPH_RETRIEVE,
    MOCK_API_QNN_DEVICE_GET_INFRAS,
    MOCK_API_QNN_INFRAS_CREAT_POWER_CONFIG_ID,
    MOCK_API_QNN_INFRAS_DESTROY_POWER_CONFIG_ID,
    MOCK_API_QNN_INFRAS_SET_POWER_CONFIG_ID,
    MOCK_API_QNN_MEMORY_REGISTER,
    MOCK_API_QNN_PROFILE_CREATE,
    MOCK_API_QNN_PROFILE_FREE,
    MOCK_API_QNN_PROFILE_GET_EVENTS,
    MOCK_API_QNN_PROFILE_GET_EVENT_DATA,
    MOCK_API_QNN_MEMORY_DEREGISTER,
    MOCK_API_QNN_CONTEXT_FREE,
    MOCK_API_QNN_DEVICE_FREE,
    MOCK_API_QNN_DEVICE_FREE_PLATFORM_INFO,
    MOCK_API_QNN_BACKEND_FREE,
    MOCK_API_QNN_LOG_FREE,
    MOCK_API_MAX
} MockAPI_ID_e;
