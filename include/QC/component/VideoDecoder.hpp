...
#ifndef QC_VIDEO_DECODER_HPP
#define QC_VIDEO_DECODER_HPP
...
typedef struct
{
    ...
    QCSharedBuffer_t *pInputBufferList = nullptr;  /**< bufferList ptr for input buffer */
    QCSharedBuffer_t *pOutputBufferList = nullptr; /**< bufferList ptr for output buffer */

    QCImageFormat_e inFormat;  /**< compress mode, now support h264 and h265 */
    QCImageFormat_e outFormat; /**< support NV12, NV12_UBWC, P010 */
...
public:
     ...
     */
    QCStatus_e Init( const char *pName, const VideoDecoder_Config_t *pConfig,
     ...
     * @return QC_STATUS_OK on success, others on failure
     */
    QCStatus_e SubmitInputFrame( const VideoDecoder_InputFrame_t *pInput );
     ...
     * @return QC_STATUS_OK on success, others on failure
     */
    QCStatus_e SubmitOutputFrame( const VideoDecoder_OutputFrame_t *pOutput );
     ...
     * @return QC_STATUS_OK on success, others on failure
     */
    QCStatus_e RegisterCallback( VideoDecoder_InFrameCallback_t inputDoneCb,
...
private:
    ...
    QCStatus_e ValidateConfig( const char *name, const VideoDecoder_Config_t *cfg );
    QCStatus_e InitFromConfig( const VideoDecoder_Config_t *cfg );
