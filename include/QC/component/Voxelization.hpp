...
#ifndef QC_VOXELIZATION_HPP
#define QC_VOXELIZATION_HPP
...
public:
     ...
     */
    QCStatus_e Init( const char *pName, const Voxelization_Config_t *pConfig,
     ...
     * @return QC_STATUS_OK on success, others on failure
     */
    QCStatus_e Execute( const QCSharedBuffer_t *pInPts, const QCSharedBuffer_t *pOutPlrs,
...
private:
    ...
    QCSharedBuffer_t m_numOfPts;     /*internal buffer used by OpenCL kernel*/
    QCSharedBuffer_t m_coorToPlrIdx; /*internal buffer used by OpenCL kernel*/

private:
    QCStatus_e ExecuteCL( const QCSharedBuffer_t *pInPts, const QCSharedBuffer_t *pOutPlrs,
                          const QCSharedBuffer_t *pOutFeature );
