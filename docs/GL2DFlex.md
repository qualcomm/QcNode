...
- [2. QC GL2DFlex Data Structures](#2-qc-gl2dflex-data-structures)
...
- [3. QC GL2DFlex APIs](#3-qc-gl2dflex-apis)
- [4. Typical Use Case](#4-typical-use-case)

# 1. Introduction
The QC GL2DFlex component offers a range of camera image processing functions, such as cropping, downscaling, upscaling, and color conversion. It works based on OpenGL ES and is compatible with the HGY platform. Additionally, it provides a user-friendly API and a high-performance function library.

# 2. QC GL2DFlex Data Structures

- [GL2DFlex_Config_t](../include/QC/component/GL2DFlex.hpp#L68)
- [GL2DFlex_InputConfig_t](../include/QC/component/GL2DFlex.hpp#L59)
- [GL2DFlex_ROIConfig_t](../include/QC/component/GL2DFlex.hpp#L51)
- [GL2DFlex_ImageResolution_t](../include/QC/component/GL2DFlex.hpp#L42)
...
# 3. QC GL2DFlex APIs
- [Initialize the GL2DFlex component](../include/QC/component/GL2DFlex.hpp#L94)
- [Start the GL2DFlex pipeline](../include/QC/component/GL2DFlex.hpp#L102)
- [Stop the GL2DFlex pipeline](../include/QC/component/GL2DFlex.hpp#L109)
- [Deinitialize the GL2DFlex component](../include/QC/component/GL2DFlex.hpp#L116)
- [Execute the GL2DFlex pipeline](../include/QC/component/GL2DFlex.hpp#L126)
- [Register shared buffers for each input](../include/QC/component/GL2DFlex.hpp#L136)
- [Register shared buffers for output](../include/QC/component/GL2DFlex.hpp#L147)
- [Deregister shared buffers for each input](../include/QC/component/GL2DFlex.hpp#L158)
- [Deregister shared buffers for output](../include/QC/component/GL2DFlex.hpp#L168)

# 4. Typical Use Case
The QC GL2DFlex component is used for image cropping, color conversion and downscaling/upscaling. User just needs to set input/output configuration parameters, then call the QC Init/Start API to launch this component. Here is an example use case that converts UYVY to NV12 and do cropping:
